...
public class TestJDBC {
	// Chaine de connexion
	static final String CONNECT_URL = "jdbc:mysql://mysql-johann-robbe.alwaysdata.net:3306/johann-robbe_1";
	static final String LOGIN = "144383_ut1";
	static final String PASSWORD = "ami123";
	// La requete de test
